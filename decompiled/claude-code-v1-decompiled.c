...
int subtract_numbers(int param_1,int param_2)
...
float power(float param_1,int param_2)
...
uint xor_transform(uint param_1,uint param_2)
...

{
  ...
  uVar1 = add_numbers(10,5);
  printf("Add: %d + %d = %d\n",10,5,(ulong)uVar1,param_5,param_6,param_2);
  printf("Counter: %d\n",(ulong)g_counter);
  uVar1 = subtract_numbers(10,5);
  printf("Subtract: %d - %d = %d\n",10,5,(ulong)uVar1);
  printf("Flag: %c\n",(ulong)(uint)(int)g_flag);
  fVar2 = (float)power(0x40000000,5);
  printf("Power: 2^5 = %.2f\n",(double)fVar2);
  printf("Global result: %.2f\n",(double)g_result);
  uVar1 = xor_transform(0x12345678,0xabcdef00);
  printf("XOR: 0x%X\n",(ulong)uVar1);
  printf("Secret: 0x%X\n",(ulong)g_secret);
  return 0;
}
