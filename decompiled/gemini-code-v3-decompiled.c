...

{
  ...
  iVar1 = DAT_00104010 * 0x14;
  dVar2 = pow((double)DAT_00104014,5.0);
  if (iVar1 < 0x1e) {
...

{
  ...
  __libc_start_main(FUN_001010a0,param_2,&stack0x00000008,0,0,param_1,auStack_8);
  do {
...
int FUN_00101290(int param_1,int param_2)
...
{
  return DAT_00104010 * (param_1 - param_2);
}
